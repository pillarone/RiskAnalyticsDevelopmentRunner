...
trait ScalarMixin {
     ...
     */
    implicit def toScalarProjection(impl: GridProjection): ScalarProjectionPimp =
        new ScalarProjectionPimp(impl)
    ...
    implicit def toScalarCacheProjection[K, V](impl: GridCacheProjection[K, V]): ScalarCacheProjectionPimp[K, V] =
        new ScalarCacheProjectionPimp[K, V](impl)
